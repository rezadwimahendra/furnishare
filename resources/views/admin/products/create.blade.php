...
@section('title', 'Tambah Produk Baru - Furnishare Admin')
...
@section('content')
    <div class="mb-10">
        ...
        <h1 class="serif-logo text-3xl font-bold text-gray-900">Tambah Produk Baru</h1>
    </div>
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Kursi Kayu Jati Minimalis" class="w-full bg-gray-50 border border-gray-200 focus:border-[#C5A880] focus:ring-1 focus:ring-[#C5A880] rounded-lg px-4 py-3 text-xs text-gray-800 focus:outline-none">
                    @error('name')
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="8" placeholder="Tulis deskripsi detail produk, termasuk keunggulan, bahan baku utama, dimensi ukuran dasar, dan rekomendasi penataan ruang." class="w-full bg-gray-50 border border-gray-200 focus:border-[#C5A880] focus:ring-1 focus:ring-[#C5A880] rounded-lg px-4 py-3 text-xs text-gray-800 focus:outline-none leading-relaxed">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-[10px] text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center bg-gray-50 border border-gray-200 rounded-lg px-4 py-3">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price') }}" required min="0" placeholder="1500000" class="bg-transparent border-0 w-full focus:outline-none text-xs font-bold text-gray-800 focus:ring-0 p-0">
                    </div>
                    @error('price')
                        <p class="text-[10px] text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" value="{{ old('stock', 10) }}" required min="0" placeholder="25" class="w-full bg-gray-50 border border-gray-200 focus:border-[#C5A880] focus:ring-1 focus:ring-[#C5A880] rounded-lg px-4 py-3 text-xs text-gray-800 focus:outline-none">
                    @error('stock')
                        <p class="text-[10px] text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-8 space-y-6">
                ...
                <!-- Cover Image -->
                <div>
                    <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">Cover Image Produk</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-8 space-y-4">
                <button type="submit" class="w-full inline-flex justify-center items-center bg-[#1A1A1A] hover:bg-[#C5A880] text-white text-xs font-bold tracking-wider uppercase py-4 rounded-xl shadow-md transition duration-200">
                    Simpan Produk Baru <i class="fa-solid fa-check ml-2 text-[10px]"></i>
                </button>
    ...
    <script>
        function removeRow(button) {
            ...
            // Allow removal only if there are other rows or just clear values
